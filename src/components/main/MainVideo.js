...
// Large component here.  We basically disable the normal webkit video controls, and build our own
...
export default function MainVideo({ screen, setScreen, project }) {
    ...
    // Keyboard shortcuts for the user
    ...
    return (
        <div className='video' pause={paused.toString()} screen={screen}>
            ...
            <video
                ...
                onMouseOver={e => e.target.poster = project.video.gif}
                onMouseLeave={e => e.target.poster = project.video.poster}
            >
                <track kind='captions' srcLang='en' src={project.video.subtitles} />
            </video>
        </div>
    )
}